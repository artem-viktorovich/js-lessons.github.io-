...
buttonAddition.addEventListener('click', onOperationButtonClick);
buttonSubtraction.addEventListener('click', onOperationButtonClick);
buttonMultiplication.addEventListener('click', onOperationButtonClick);
